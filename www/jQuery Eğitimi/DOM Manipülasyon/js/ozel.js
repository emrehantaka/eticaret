...
//Height ve Width Bulma
/*
$(function(){

var boy=$('.emrah').height();

	//$('.emrah').width(600);

	$('p').text($('.emrah').height()+" - "+$('.emrah').width());


	$('button').click(function(){

		//alert("Yüksekliği "+$('.emrah').height()+" px")
		//alert("Genişliği "+$('.emrah').width()+" px")
...
$().ready(function(){
	...
	$('button').click(function(){
		...
		alert($('.udemy').offset().top+" olarak değiştirildi")
	})
})*/
...
$().ready(function(){
	...
	var posizyon=$("p").position();

	$('b').text("Soldan uzaklık : "+posizyon.left);
	$('b').append("Yukarıdan uzaklık : "+posizyon.top)
})*/
