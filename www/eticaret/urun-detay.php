...
ob_end_clean();
$title = $uruncek['urun_ad']." | ".$ayarcek['ayar_title'];
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<?php  } else { ?>
										...
										<button type="submit" disabled name="sepetekle" class="btn btn-default btn-red btn-sm"><span class="addchart">Giriş Yapın</span></button>
